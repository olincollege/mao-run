...
if __name__ == '__main__':
    ...
    while game_start:
        ...
        # Else, update the display and continue this iretation of the game
            ...
            if best_score == randint(20, 90):
                current_obstacle.X_VELOCITY["left"] -= randint(25, 45)/10
                current_obstacle.X_VELOCITY["right"] += randint(25, 45)/10
            elif best_score == randint(90, 1000):
                current_obstacle.X_VELOCITY["left"] -= randint(50, 60)/10
                current_obstacle.X_VELOCITY["right"] += randint(50, 60)/10
            CUR_WORLD.display()
